...
namespace MegaDesk_3
{
    public partial class AddQuote : Form
    {
        ...
        public AddQuote(MainMenuForm mainMenuForm)
        {
            ...
            //Assigns the current date without getting user input 
            ...
            //Sets ArrayList of DesktopMaterial
            ArrayList materials = new ArrayList();
            int enumlen = Enum.GetValues(typeof(Desk.DesktopMaterial)).Length;
            Array materialNames = Enum.GetValues(typeof(Desk.DesktopMaterial));
